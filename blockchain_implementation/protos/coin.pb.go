...
type TXI struct {
	...
	// In theory you don't need the senderPubKey / value
	// because you use the txID and index to look it up
...
func (m *TXI) Reset()         { *m = TXI{} }
func (m *TXI) String() string { return proto.CompactTextString(m) }
func (*TXI) ProtoMessage()    {}
func (*TXI) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{0}
}
func (m *TXI) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TXI.Unmarshal(m, b)
}
func (m *TXI) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TXI.Marshal(b, m, deterministic)
}
func (dst *TXI) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TXI.Merge(dst, src)
}
func (m *TXI) XXX_Size() int {
	return xxx_messageInfo_TXI.Size(m)
}
func (m *TXI) XXX_DiscardUnknown() {
	xxx_messageInfo_TXI.DiscardUnknown(m)
}

var xxx_messageInfo_TXI proto.InternalMessageInfo

func (m *TXI) GetTxID() []byte {
	if m != nil {
		return m.TxID
	}
	return nil
...
type TXO struct {
	ReceiverPubKey []byte `protobuf:"bytes,1,opt,name=receiverPubKey,proto3" json:"receiverPubKey,omitempty"`
	// Just needs
...
func (m *TXO) Reset()         { *m = TXO{} }
func (m *TXO) String() string { return proto.CompactTextString(m) }
func (*TXO) ProtoMessage()    {}
func (*TXO) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{1}
}
func (m *TXO) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TXO.Unmarshal(m, b)
}
func (m *TXO) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TXO.Marshal(b, m, deterministic)
}
func (dst *TXO) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TXO.Merge(dst, src)
}
func (m *TXO) XXX_Size() int {
	return xxx_messageInfo_TXO.Size(m)
}
func (m *TXO) XXX_DiscardUnknown() {
	xxx_messageInfo_TXO.DiscardUnknown(m)
}

var xxx_messageInfo_TXO proto.InternalMessageInfo

func (m *TXO) GetReceiverPubKey() []byte {
	if m != nil {
...
type Transaction struct {
	...
	Vin []*TXI `protobuf:"bytes,1,rep,name=vin,proto3" json:"vin,omitempty"`
	...
	Vout []*TXO `protobuf:"bytes,3,rep,name=vout,proto3" json:"vout,omitempty"`
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{2}
}
...
func (m *Transaction) GetVout() []*TXO {
	if m != nil {
		return m.Vout
	}
	return nil
...
func (*BlockHeader) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{3}
}
...
func (*Block) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{4}
}
...
func (*Empty) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{5}
}
...
func (*Hello) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{6}
}
...
func (*Ack) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{7}
}
...
func (*TransactionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{8}
}
...
func (m *TransactionRequest) GetReceiverPubKey() []byte {
	if m != nil {
		return m.ReceiverPubKey
	}
	return nil
...
func (m *TransactionRequest) GetValue() uint64 {
	if m != nil {
		return m.Value
	}
	return 0
...
func (*Account) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{9}
}
...
func (*AccountCreated) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{10}
}
...
func (*Balance) Descriptor() ([]byte, []int) {
	return fileDescriptor_coin_9c8380c765b8f954, []int{11}
}
...
func init() {
	proto.RegisterType((*TXI)(nil), "protos.TXI")
	proto.RegisterType((*TXO)(nil), "protos.TXO")
...
type TransactionsClient interface {
	...
	SendTransaction(ctx context.Context, in *TransactionRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *transactionsClient) SendTransaction(ctx context.Context, in *TransactionRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type TransactionsServer interface {
	...
	SendTransaction(context.Context, *TransactionRequest) (*Empty, error)
}
...
func _Transactions_SendTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionsServer).SendTransaction(ctx, req.(*TransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("coin.proto", fileDescriptor_coin_9c8380c765b8f954) }

var fileDescriptor_coin_9c8380c765b8f954 = []byte{
	// 656 bytes of a gzipped FileDescriptorProto
	,
}
